...
class LineEditor:
    ...
    def clear_selection(self):
        ...
        self.snap_markers = []
        # Reset processed lines list
        if hasattr(self, 'processed_lines'):
    ...
    def on_trim_mid_select(self, event):
        ...
        if self.trim_state == 'first_line':
            ...
            if item_id not in self.selected_lines and item_id not in getattr(self, 'processed_lines', []):
                # Store processed lines to prevent multiple operations
                if not hasattr(self, 'processed_lines'):
                    self.processed_lines = []
                ...
                if intersection1 and intersection2:
                    ...
                    self.processed_lines.append(item_id)
