...
line_editor_button.place(x=900, y=30)  # Positioned below Live Feed button

# Add this near the end of the file, after creating the main window
def initialize_windows():
    layers_window = LayersWindow(win, cv)  # Open layers window
    return layers_window

# Add this after creating the main window and before mainloop
layers_window = initialize_windows()
