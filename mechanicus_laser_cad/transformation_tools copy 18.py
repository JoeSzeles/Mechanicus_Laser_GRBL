...
class TransformationTools:
    ...
    def bind_clone_events(self):
        ...
        self.unbind_all_events()
        self.canvas.bind('<Button-1>', self.on_canvas_click)
        self.canvas.bind('<Alt_L-Button-1>', self.on_alt_click)
        self.canvas.bind('<Alt_L-B1-Motion>', self.on_clone_drag)
        self.canvas.bind('<Alt_L-ButtonRelease-1>', self.on_clone_release)
